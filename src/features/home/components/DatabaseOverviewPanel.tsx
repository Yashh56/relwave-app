    ...
    <div className="flex-1 p-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <Card className="@container/card">
          ...
          <CardContent className="text-lg font-semibold">{tables}</CardContent>
        </Card>
        <Card className="@container/card">
          <CardHeader className="flex flex-row items-center justify-between text-xs">
          ...
          <CardContent className="text-lg font-semibold">{size}</CardContent>
        </Card>
      </div>
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <Card className="@container/card">
              ...
              <CardFooter className="text-xs text-muted-foreground mt-1">Diagram layout</CardFooter>
            </Card>
            ...
            <Card className="@container/card">
              ...
              <CardFooter className="text-xs text-muted-foreground mt-1">Stored queries</CardFooter>
            </Card>
          </div>
        </>
      )}
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <Card className="@container/card">
              ...
              <CardFooter className="text-xs text-muted-foreground mt-1">Cached schemas</CardFooter>
            </Card>
