      ...
      <div className="p-6 border-b border-border/50 bg-card/45 backdrop-blur-xl">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-4">
            ...
            >
              <Database className={cn("h-7 w-7", getDbColors(database.type).text)} />
            </div>
            <div>
              <div className="mb-2">
                <Button
                  ...
                  size="sm"
                  onClick={onBack}
                  className="h-8 px-2 text-muted-foreground -ml-2"
                >
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="sm" onClick={onTest} className="h-8 text-xs">
              <Zap className="h-3.5 w-3.5 mr-1.5" />
              Test
            </Button>
            <Button size="sm" onClick={onOpen} disabled={!isConnected} className="h-8 text-xs">
