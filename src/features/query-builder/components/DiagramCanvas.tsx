    ...
    <div className="flex-1 relative min-h-75">
      ...
      {menuPosition && selectedEdge && (
        <>
          ...
          >
            <div className="text-[10px] font-medium text-muted-foreground mb-1 px-2">Join Type</div>
            {[
      ...
      {nodes.length === 0 && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="text-center rounded-lg border border-border/50 bg-background/70 p-6 shadow-sm backdrop-blur-sm">
            ...
            <p className="text-xs text-muted-foreground/40 mt-1">Connect tables to create joins</p>
          </div>
        </div>
      )}
    </div>
