...
export default function DropTableDialog({
  ...
  const { handleClose, handleSubmit, setConfirmText, setMode, mode, confirmText, isSubmitting } =
    useDropTableDialog({
      open,
      onOpenChange,
      dbId,
      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <span className="font-mono font-medium">{schemaName}</span>. A migration will be created
