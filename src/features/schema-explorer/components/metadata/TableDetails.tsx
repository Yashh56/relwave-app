      ...
      <Tabs defaultValue="columns" className="w-full">
                ...
                <Card key={idx}>
                  <CardContent className="pt-4">
                    ...
                    <div className="flex gap-4 mt-3 text-xs text-muted-foreground">
                      <span>
                        ON UPDATE:{" "}
                        <span className="font-medium text-foreground">{fk.update_rule}</span>
                      </span>
                      <span>
                        ON DELETE:{" "}
                        <span className="font-medium text-foreground">{fk.delete_rule}</span>
                      </span>
                    </div>
                  </CardContent>
                </Card>
        ...
        <TabsContent value="indexes" className="mt-4">
          {table.indexes && table.indexes.length > 0 ? (
            ...
            <div className="text-sm text-muted-foreground text-center py-8">No indexes defined</div>
          )}
        </TabsContent>
