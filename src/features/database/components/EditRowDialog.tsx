...
export default function EditRowDialog({
  ...
  const { formData, nullFields, submitting, handleInputChange, toggleNull, handleSubmit, columns } =
    useEditDialog({
      open,
      onOpenChange,
      dbId,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-130">
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={submitting} size="sm" className="text-xs">
            {submitting ? (
              <>
